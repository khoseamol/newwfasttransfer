...
public class TravelDashboardAdapter extends RecyclerView.Adapter<TravelDashboardAdapter.MyViewHolder> {

    private List<TravelModel> transactionList;
    Context mContext;
    ...
    public TravelDashboardAdapter(Context mContext, ArrayList<TravelModel> horizontalList , ItemClickEvent itemClickEvent) {
