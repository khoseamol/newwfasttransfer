        ...
        result.enqueue(new Callback<RechargePlan>() {
            ...
            public void onResponse(Call<RechargePlan> call, Response<RechargePlan> response) {
                ...
                if (rechargePlans.getResult().getStatus().equals("Success")) {
                    ...
                    data = ListViewDataFilter.filterByRecharegePlans(rechargePlans.getResult().getData(), "Other");
                    data = ListViewDataFilter.filterByRecharegePlans(rechargePlans.getResult().getData(), "Local");
                    data = ListViewDataFilter.filterByRecharegePlans(rechargePlans.getResult().getData(), "SMS");
...
//                            data = ListViewDataFilter.filterByRecharegePlans(rechargePlansByOperatorResponse.getResult().getData(), "Other");
//                            data = ListViewDataFilter.filterByRecharegePlans(rechargePlansByOperatorResponse.getResult().getData(), "Local");
//                            data = ListViewDataFilter.filterByRecharegePlans(rechargePlansByOperatorResponse.getResult().getData(), "SMS");
//                            rechargePlansRecyclerAdapter = new RechargePlansRecyclerAdapter(getActivity(), data);
//                            mMy_recycler_view.setAdapter(rechargePlansRecyclerAdapter);
//
//                        } else {
