...
/**
 * Created by webplat on 08/10/2015.
 */
public class PrefUtils {
    ...
    public void removeMoneyPref(Context mContext) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mContext);
        final SharedPreferences.Editor editor = prefs.edit();
        editor.remove("login");
        editor.remove("BALANCE");
        editor.remove("NAME");
        editor.remove("MIDDLENAME");
        ...
        editor.remove("KYCSTATUS");
        editor.remove("CARDNO");
        editor.remove("SECURITYKEY");
        editor.remove("TRANSACTIONLIMIT");
