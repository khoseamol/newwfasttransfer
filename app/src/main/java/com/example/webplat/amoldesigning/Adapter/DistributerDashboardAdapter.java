...
public class DistributerDashboardAdapter extends RecyclerView.Adapter<DistributerDashboardAdapter.MyViewHolder> {
    ...
    public DistributerDashboardAdapter(Context mContext, ArrayList<Transction> horizontalList , ItemClickEvent itemClickEvent) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.horizontalsingleitem_view4, parent, false);
